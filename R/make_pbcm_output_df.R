  ...
  if (print_genargs) {
    if (length(genargs2) != 0) {
      for (i in length(genargs2):1) {
        ...
        names(out1)[1] <- paste0("genargs2_", names(genargs2)[i])
      }
    }
    ...
    if (length(genargs1) != 0) {
      for (i in length(genargs1):1) {
        ...
        names(out1)[1] <- paste0("genargs1_", names(genargs1)[i])
      }
    }
    ...
    if (length(genargs2) != 0) {
      for (i in length(genargs2):1) {
        ...
        names(out2)[1] <- paste0("genargs2_", names(genargs2)[i])
      }
    }
    ...
    if (length(genargs1) != 0) {
      for (i in length(genargs1):1) {
        ...
        names(out2)[1] <- paste0("genargs1_", names(genargs1)[i])
      }
    }
  }
